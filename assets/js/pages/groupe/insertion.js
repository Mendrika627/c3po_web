$(() => {
    ...
    modal.on('show.bs.modal', () => {
      ...
      form.permissions.forEach(permission => {
        ...
        if(permission.creation != null) permission.creation.prop('checked', false)
  
        if(permission.modification != null) permission.modification.prop('checked', false)
  
        if(permission.visualisation != null) permission.visualisation.prop('checked', false)
  
        if(permission.suppression != null) permission.suppression.prop('checked', false)
