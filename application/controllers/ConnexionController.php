<?php
    ...
    class ConnexionController extends EchantillonageController{
        ...
        public function operation_validation_login() {
          ...
          $donnees_formulalire = array('login_identifiant' => $_POST['identifiant'], 'login_mot_de_passe' => hash('sha256', $_POST['motDePasse']));
          ...
          if ($existe) {
            ...
            $information_login['groupe']['autorisations'] = $this->db_groupe->selection_autorisation_par_groupe($information_login['groupe']['groupe_id']);
