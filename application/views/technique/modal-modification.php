    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Technique de niveau 1</h4>
            ...
            <div class="modal-body">
                ...
                <form autocomplete="off" id="js-formulaire-modification">
                    ...
                    <div class="form-group">
						...
						<input type="text" class="form-control js-nom-technique-niv-1">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control js-description-technique-niv-1" rows="3" placeholder="Description"></textarea>
            ...
            <div class="modal-footer justify-content-between">
				...
				<button type="button" class="btn btn-primary js-enregistrer" id="js-enregistrer-modification"><i class="fa fa-save mr-2"></i>Enregistrer</button>
