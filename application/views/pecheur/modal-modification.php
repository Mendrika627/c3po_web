			...
			<div class="modal-body">
				...
				<form autocomplete="off" id="js-formulaire-modification">
					...
					<div class="form-group">
						...
						<label><input type="checkbox" id="js-confidentiel-pecheur-modification" class="minimal js-confidentiel-pecheur"> Garder les infos confidentielles <span class="text text-red">*</span></label>
						<span class="form-text text-red" style="display: none;"></span>
